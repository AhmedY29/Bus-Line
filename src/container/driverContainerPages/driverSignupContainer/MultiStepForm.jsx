    ...
    <div className="p-4 bg-gray-50 h-screen">
      ...
      <div className="p-4 bg-gray-50">
        <nav className="h-[10vh] flex justify-start items-center px-4">
          <Link to="/" className="flex items-center gap-2">
            <div className="flex items-center gap-3 mr-2">
              <img
                src="/logo.png" // Corrected to relative path
                alt="Logo"
        ...
        <div className="flex justify-evenly mt-8">
          ...
          <button
            onClick={currentStep === steps.length - 1 ? handleFinish : goToNextStep}
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 bg-gray-50 bg-opacity-50">
            <div className="bg-white p-6 rounded-lg shadow-md w-96">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-medium">Your request is under review</h3>
              </div>
              <p className="mb-4">
