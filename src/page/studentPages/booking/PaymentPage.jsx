...
import { CreditCard, Shield, ArrowLeft, Check, Wallet, Smartphone } from "lucide-react";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <CardContent>
              <RadioGroup value={paymentMethod} onValueChange={setPaymentMethod} className="space-y-4">
                ...
                <div className="flex items-center space-x-3 p-4 rounded-lg border-2 border-gray-200 hover:border-blue-500 transition-colors">
                  ...
                  <div className="flex-1">
                    <Label htmlFor="wallet" className="font-semibold">Digital Wallet</Label>
                    <p className="text-sm text-gray-600">Fawry, Vodafone Cash, Orange Money</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 p-4 rounded-lg border-2 border-gray-200 hover:border-blue-500 transition-colors">
                  ...
                  <div className="flex-1">
                    <Label htmlFor="mobile" className="font-semibold">Mobile Payment</Label>
          ...
          {paymentMethod === "card" && (
            <Card className="bus-card border-0">
              <CardHeader>
                <CardTitle className="text-xl font-bold">Card Details</CardTitle>
              </CardHeader>
          ...
          {paymentMethod === "mobile" && (
            <Card className="bus-card border-0">
              <CardHeader>
                <CardTitle className="text-xl font-bold">Mobile Payment</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
