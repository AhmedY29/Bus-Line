    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50 p-4">
      <Card className="w-full max-w-lg text-center shadow-lg animate-in fade-in-50">
        <CardHeader>
          ...
          <CardDescription>Your payment was successful and your trip is booked.</CardDescription>
        </CardHeader>
        <CardContent className="p-6">
          <div className="text-left bg-gray-50 p-4 rounded-lg border space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-semibold">{trip.neighborhood} → {trip.destinationId.title}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">Date</span>
              <span className="font-semibold">{new Date(trip.tripDateStart).toLocaleDateString()}</span>
            </div>
            <div className="flex justify-between">
            ...
            <div className="flex justify-between text-lg">
              ...
              <span className="font-bold text-green-600">{trip.tripPrice * passengers} SAR</span>
            </div>
          </div>
